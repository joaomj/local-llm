...
- Start near the current best configuration: Gemma 4 12B QAT GGUF, 32K context, no flash attention.
...
- Update `best_command.sh` if performance improves meaningfully without hurting stability or quality.
